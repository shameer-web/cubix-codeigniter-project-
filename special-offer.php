                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <h3 class="breadcrumb-title">SPECIAL OFFER</h3>
                                ...
                                <div class="tab-pane fade show active" id="tab1">
                                    <div class="product-carousel-4_2 slick-row-5 slick-arrow-style">
                                        <!-- product single item start -->
                                           ...
                                           <?php
                               $res=$obj->special_offer(" where category='1'&& delete_status='0'");
                               while($row=mysqli_fetch_assoc($res)){
                                ...
                                ?>
                                        <div class="product-item">
                                            <div class="product-thumb" style="height: 300px">
                                                <a href="#">
                                                    <img src="cubix_admin/uploads/special_offer/<?php echo $row['product_image']; ?>" alt="product thumb">
                                                </a>
                                                ...
                                                <div class="product-label">
                                                    <span><?php echo $row['offer_percentage']; ?>%</span>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="tab2">
                                    <div class="product-carousel-4_2 slick-row-5 slick-arrow-style">
                                        <!-- product single item start -->
                                         <?php
                               $res=$obj->special_offer(" where category='2'&& delete_status='0'");
                               while($row=mysqli_fetch_assoc($res)){
                                ...
                                <div class="tab-pane fade" id="tab3">
                                    <div class="product-carousel-4_2 slick-row-5 slick-arrow-style">
                                     ...
                                     <?php
                               $res=$obj->special_offer(" where category='3'&& delete_status='0'");
                               while($row=mysqli_fetch_assoc($res)){
