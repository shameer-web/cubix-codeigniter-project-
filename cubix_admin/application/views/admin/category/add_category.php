            ...
            <div class="m-content">
                <div class="m-portlet m-portlet--mobile m-portlet--mobile m-portlet--info m-portlet--head-solid-bg m-portlet--bordered m-portlet--rounded">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                    <a href="#" data-toggle="modal" data-target="#category_add_modal" class="btn btn-focus m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                        <span>
                        ...
                        <!--end: Search Form -->
                        <!--begin: Datatable -->
                        <table width="100%" class="table m-table nowrap table-header-fixed table-striped table-bordered table-hover table-header-fixed" id="category_view_table">
                            <thead>
                            <tr class="">
                                <th>ID</th>
                        ...
                        <div class="modal fade" tabindex="-1" id="category_add_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" style="max-width: 675px">
                                <div class="modal-content">
                                    ...
                                    <form id="form_category_add" method="post" action="<?php echo base_url().$user_directory.'category/create'?>" class="m-form m-form--fit m-form--state m-form--label-align-right " enctype="multipart/form-data" >
                                        <div class="modal-body">
                                            <div class="m-form__content">
                                                <div class="m-alert m-alert--icon alert alert-warning m--hide" role="alert" id="form_category_add_msg">
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                          ...
                                                          <input type="text" name="category" id="category1" class="col-lg-12">
                        ...
                        <div class="modal fade" tabindex="-1" id="category_edit_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" style="max-width: 675px">
                                <div class="modal-content">
                                    ...
                                    <form id="form_category_edit" method="post" action="<?php echo base_url().$user_directory.'category/update'?>" class="m-form m-form--fit m-form--state m-form--label-align-right " enctype="multipart/form-data" >
                                        <div class="modal-body">
                                            <div class="m-form__content">
                                                <div class="m-alert m-alert--icon alert alert-warning m--hide" role="alert" id="form_category_edit_msg">
                                                    <div class="m-alert__icon">
                                                        <i class="la la-warning"></i>
                                                    </div>
                                                    <div class="m-alert__text">
                        ...
                        <div class="modal fade" tabindex="-1" id="category_delete_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    // Menu Active
    $("#menu_category").addClass('m-menu__item--active');
