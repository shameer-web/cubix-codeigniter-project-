            ...
            <div class="m-content">
                <div class="m-portlet m-portlet--mobile m-portlet--mobile m-portlet--info m-portlet--head-solid-bg m-portlet--bordered m-portlet--rounded">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                   ...
                                   <a href="<?php echo base_url().$user_directory.'cat'?>" class="btn btn-success m-btn  m-btn--icon m-btn--air m-btn--pill">
                                        <span>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#cat_more_add_modal" class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                        <span>
                        ...
                        <!--end: Search Form -->
                        <!--begin: Datatable -->
                        <input type="hidden" value="<?php echo $c_id ?>" id="c_id">
                        <table width="100%" class="table m-table nowrap table-header-fixed table-striped table-bordered table-hover table-header-fixed" id="cat_more_view_table">
                            <thead>
                            <tr class="">
                                <th>ID</th>
                                <th>Sub Category</th>
                        ...
                        <div class="modal fade" tabindex="-1" id="cat_more_add_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" style="max-width: 675px">
                                <div class="modal-content">
                                    ...
                                    <form id="form_cat_more_add" method="post" action="<?php echo base_url().$user_directory.'cat/more_create'?>" class="m-form m-form--fit m-form--state m-form--label-align-right " enctype="multipart/form-data" >
                                        <div class="modal-body">
                                            <div class="m-form__content">
                                                <div class="m-alert m-alert--icon alert alert-warning m--hide" role="alert" id="form_cat_more_add_msg">
                                            ...
                                            <input type="hidden" name="c_id" value="<?php echo $result->id ?>">
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                          ...
                                                          <input type="text" name="sub_category"  class="col-lg-12" >
                        ...
                        <div class="modal fade" tabindex="-1" id="cat_more_delete_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" >
                                <form id="user_delete_form" action="<?php echo base_url().$user_directory.'cat/more_delete'?>" method="post" class="form-horizontal">
                                    <div class="modal-content">
...
<!--begin::Page Snippets -->
<?php $this->view("custom_scripts/cat_more_scripts");?>
<!--end::Page Snippets -->