...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                var table = $('#cat_more_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/cat/more_select", // json datasource
        ...
        add=function() {
            $("#form_cat_more_add").validate( {
                ...
                , submitHandler:function(e) {
                    mApp.block("#cat_more_add_modal .modal-content", {
                        overlayColor: "#000000",
                        type: "loader",
                        state: "success",
...
<script>
    ...
    $('body').on('click', '#cat_more_delete_btn', function() {
        var no = $(this).closest('tr').children('td');
