...
//  User List Data Table
    var Datatable=function() {
        function Getid(){
            return $('#featured_id').val();
        }
        var t=function() {
                var table = $('#featured_products_more_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/featured_products/more_select", // json datasource
...
//  User Add / Edit Form Validation
    var FormControls=function() {
        ...
        add=function() {
            $("#form_featured_products_more_add").validate( {
                rules: {
                    title: {
                        required: !0
                    }
                ...
                , submitHandler:function(e) {
                    mApp.block("#featured_products_more_add_modal .modal-content", {
                        overlayColor: "#000000",
                        type: "loader",
                        state: "success",
...
<script>
    ...
    $('body').on('click', '#featured_products_more_delete_btn', function() {
        var no = $(this).closest('tr').children('td');
