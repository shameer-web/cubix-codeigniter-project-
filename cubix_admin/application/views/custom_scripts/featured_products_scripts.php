...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                var table = $('#featured_products_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/featured_products/select", // json datasource
...
//  User Add / Edit Form Validation
    var FormControls=function() {
        ...
        add=function() {
            $("#form_featured_products_add").validate( {
                rules: {
                    title: {
                        required: !0
                    }
                ...
                , invalidHandler:function(e, r) {
                    var i=$("#form_featured_products_add_msg");
                    i.removeClass("m--hide").show(), mApp.scrollTo(i, -200)
                }
                , submitHandler:function(e) {
                    mApp.block("#featured_products_add_modal .modal-content", {
                        overlayColor: "#000000",
                        type: "loader",
                        state: "success",
        ...
        edit=function() {
            $("#form_featured_products_edit").validate( {
                    rules: {
                        title: {
                            required: !0
                        },
                    ...
                    , invalidHandler:function(e, r) {
                        var i=$("#form_featured_products_edit_msg");
                        i.removeClass("m--hide").show(), mApp.scrollTo(i, -200)
                    }
                    , submitHandler:function(e) {
                        mApp.blockPage({
                        ...
                        mApp.block("#featured_products_edit_modal .modal-content", {
                            overlayColor: "#000000",
                            type: "loader",
                            state: "success",
                            message: "Processing... Please wait."
...
<script>
    $('body').on('click', '#featured_products_edit_btn', function() {
...
//         $('#img').val(no.eq(3).text());
       ...
       // $('#image').val(no.eq(1).text());
        ...
        $('#title').val(no.eq(4).text());
        $('#description').val(no.eq(5).text());
        $('#price').val(no.eq(6).text());
        $('#offer_price').val(no.eq(7).text());


    })
    $('body').on('click', '#featured_products_delete_btn', function() {
        var no = $(this).closest('tr').children('td');
