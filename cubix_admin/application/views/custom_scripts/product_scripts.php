...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                ...
                "ajax":{
                    url :"<?php echo base_url()?>admin/product/select", // json datasource
        ...
        add=function() {
            $("#form_product_add").validate( {
                ...
                , submitHandler:function(e) {
                    mApp.block("#product_add_modal .modal-content", {
                        overlayColor: "#000000",
                        type: "loader",
                        state: "success",
...
//         $('#img').val(no.eq(3).text());
       ...
       // $('#image').val(no.eq(1).text());
        ...
        $('#title').val(no.eq(5).text());
        $('#description').val(no.eq(6).text());
         $('#price').val(no.eq(7).text());
          $('#offer_price').val(no.eq(8).text());
