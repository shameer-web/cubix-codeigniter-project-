...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                var table = $('#cat_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/cat/select", // json datasource
        ...
        add=function() {
            $("#form_cat_add").validate( {
                ...
                , invalidHandler:function(e, r) {
                    var i=$("#form_cat_add_msg");
                    i.removeClass("m--hide").show(), mApp.scrollTo(i, -200)
                }
                , submitHandler:function(e) {
                    mApp.block("#cat_add_modal .modal-content", {
                        overlayColor: "#000000",
                        type: "loader",
                        state: "success",
        ...
        edit=function() {
            $("#form_cat_edit").validate( {
                    ...
                    , submitHandler:function(e) {
                        ...
                        mApp.block("#cat_edit_modal .modal-content", {
                            overlayColor: "#000000",
                            type: "loader",
                            state: "success",
                            message: "Processing... Please wait."
...
<script>
    $('body').on('click', '#cat_edit_btn', function() {
...
//         $('#img').val(no.eq(3).text());
    ...
    $('body').on('click', '#cat_delete_btn', function() {
        var no = $(this).closest('tr').children('td');
