...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                var table = $('#special_offer_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/special_offer/select", // json datasource
...
//  User Add / Edit Form Validation
    var FormControls=function() {
        ...
        add=function() {
            $("#form_special_offer_add").validate( {
                rules: {
                    title: {
                        required: !0
                    }
                ...
                , invalidHandler:function(e, r) {
                    var i=$("#form_special_offer_add_msg");
                    i.removeClass("m--hide").show(), mApp.scrollTo(i, -200)
                }
                , submitHandler:function(e) {
                    mApp.block("#special_offer_add_modal .modal-content", {
                        overlayColor: "#000000",
                        type: "loader",
                        state: "success",
        ...
        edit=function() {
            $("#form_special_offer_edit").validate( {
                    rules: {
                        title: {
                            required: !0
                        },
                    ...
                    , invalidHandler:function(e, r) {
                        var i=$("#form_special_offer_edit_msg");
                        i.removeClass("m--hide").show(), mApp.scrollTo(i, -200)
                    }
                    , submitHandler:function(e) {
                        mApp.blockPage({
                        ...
                        mApp.block("#special_offer_edit_modal .modal-content", {
                            overlayColor: "#000000",
                            type: "loader",
                            state: "success",
                            message: "Processing... Please wait."
...
<script>
    $('body').on('click', '#special_offer_edit_btn', function() {
        ...
        $('#description').val(no.eq(5).text());
         $('#price').val(no.eq(6).text());
          $('#offer_price').val(no.eq(7).text());
           $('#offer_percentage').val(no.eq(8).text());


    })
    $('body').on('click', '#special_offer_delete_btn', function() {
        var no = $(this).closest('tr').children('td');
