...
<head>
    ...
    <!--end::Base Styles -->
    <link rel="shortcut icon" href="<?php echo base_url()?>template/assets/demo/default/media/img/logo/favicon.ico" />
</head>
<!-- end::Head -->
<!-- end::Body -->
...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-1" id="m_login" style="background-image: url(<?php echo base_url()?>template/assets/app/media/img//bg/bg-1.jpg);">
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__logo">
                    <a href="#">
                        <img style="width: 79px;" src="<?php echo base_url()?>template/assets/demo/demo2/media/img/logo/cubix-logo.png">
                    </a>
                </div>
                <div class="m-login__signin">
                    ...
                    <form class="m-login__form m-form" action="<?php echo base_url()?>admin_login/process" method="post">
                        ...
                        <div class="form-group m-form__group">
                            <input class="form-control m-input"   type="text" placeholder="Email" name="email" autocomplete="off" required="required">
                        </div>
                        <div class="form-group m-form__group">
