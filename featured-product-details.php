...
$obj = new database;
 ...
 $base_url = "http://localhost/cubix/";
$id = $_GET['id'];

if(isset($id) and $id != ''){
$res=$obj->featured_product($id);
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="product-large-slider">
                                         <?php
                                $res2=$obj->featured_product_images($id);
                               ...
                               while($row=mysqli_fetch_assoc($res2)) 
                                ...
                                ?>
                                        <div class="pro-large-img img-zoom">
                                            <img src="<?php echo $base_url.'cubix_admin/uploads/featured_products/'.$row['featured_image']; ?>" alt="product-details" />
                                        </div>
